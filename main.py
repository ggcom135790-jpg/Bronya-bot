...
# --- CẤU HÌNH MỚI ---
TOKEN = "8575665648:AAH0U1xydQ6fVBWfSzm8rnLS0jDS9faoT8s" # Linh hồn mới của Seele
CHANNEL_ID = "-1003749427897"
bot = telebot.TeleBot(TOKEN)

app = Flask(__name__)
@app.route('/')
def home(): return "🦋 Seele (New Soul) v9.6: ONLINE!"
    ...
    try:
        ...
        if res:
            ...
            for i in range(0, 20, 10):
                ...
                time.sleep(1.5) 
            bot.reply_to(message, f"🦋 Seele đã dùng linh hồn mới xả xong 20 ảnh '{query}' cho Đội trưởng rồi ạ! 🤤")
        else:
            bot.reply_to(message, f"❌ Seele không tìm thấy ảnh '{query}' rồi...")
    except:
        bot.reply_to(message, "🤕 Kết nối Biển Lượng Tử đang yếu, ngài đợi Seele nhé!")
